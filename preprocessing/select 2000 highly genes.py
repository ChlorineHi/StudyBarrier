...
file_path="E:\Study\scDCCA-main\example data\muraro_preprocessed_log_genefilt_simple.csv"
...
print(adata.X.shape)
print(adata.X)
np.savetxt("example data\\muraro_2000_sample.txt", adata.X, delimiter=',')
print("完成")